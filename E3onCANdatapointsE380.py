...
dataIdentifiersE380 = {
    ...
    0x254: O3EComplexType(8, "GridCurrent", [O3EInt16(2, "L1", scale=1.0, signed=True), O3EInt16(2, "L2", scale=1.0, signed=True), O3EInt16(2, "L3", scale=1.0, signed=True), O3EcosPhi(2, "cosPhi", scale=100.0, signed=True)]),
#    0x254: O3EComplexType(8, "GridCurrent", [O3EFloat16(2, "L1", scale=1.0), O3EFloat16(2, "L2", scale=1.0), O3EFloat16(2, "L3", scale=1.0), O3EcosPhi(2, "cosPhi", scale=100.0, signed=True)]),
    0x255: O3EComplexType(8, "GridCurrent", [O3EInt16(2, "L1", scale=1.0, signed=True), O3EInt16(2, "L2", scale=1.0, signed=True), O3EInt16(2, "L3", scale=1.0, signed=True), O3EcosPhi(2, "cosPhi", scale=100.0, signed=True)]),
#    0x255: O3EComplexType(8, "GridCurrent", [O3EFloat16(2, "L1", scale=1.0), O3EFloat16(2, "L2", scale=1.0), O3EFloat16(2, "L3", scale=1.0), O3EcosPhi(2, "cosPhi", scale=100.0, signed=True)]),
    ...
    0x25C: O3EComplexType(4, "GridEnergy", [O3EInt32(4, "ImportCumulated", scale=100, signed=False)]),   # Cumulated import (kWh)
    0x25D: O3EComplexType(4, "GridEnergy", [O3EInt32(4, "ImportCumulated", scale=100, signed=False)])    # Cumulated import (kWh)
}
