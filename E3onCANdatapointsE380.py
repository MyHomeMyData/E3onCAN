...
#   0x254: E3ComplexType(8, "GridCurrent", [E3Int16(2, "L1", scale=1.0, signed=True), E3Int16(2, "L2", scale=1.0, signed=True), E3Int16(2, "L3", scale=1.0, signed=True), E3cosPhi(2, "cosPhi", scale=100.0, signed=True)]),
    0x254: E3ComplexType(8, "GridCurrent", [E3Float16(2, "L1", scale=1.0), E3Float16(2, "L2", scale=1.0), E3Float16(2, "L3", scale=1.0), E3cosPhi(2, "cosPhi", scale=100.0, signed=True)]),
#    0x255: E3ComplexType(8, "GridCurrent", [E3Int16(2, "L1", scale=1.0, signed=True), E3Int16(2, "L2", scale=1.0, signed=True), E3Int16(2, "L3", scale=1.0, signed=True), E3cosPhi(2, "cosPhi", scale=100.0, signed=True)]),
    0x255: E3ComplexType(8, "GridCurrent", [E3Float16(2, "L1", scale=1.0), E3Float16(2, "L2", scale=1.0), E3Float16(2, "L3", scale=1.0), E3cosPhi(2, "cosPhi", scale=100.0, signed=True)]),
    ...
    0x258: E3ComplexType(8, "GridEnergy", [E3Float32(4, "ImportCumulated", scale=1000.0), E3Float32(4, "ExportCumulated", scale=1000.0)]),  # Cumulated import and export (kWh)
    0x259: E3ComplexType(8, "GridEnergy", [E3Float32(4, "ImportCumulated", scale=1000.0), E3Float32(4, "ExportCumulated", scale=1000.0)]),  # Cumulated import and export (kWh)
