...
dataIdentifiersE380 = {
    ...
    0x258: E3ComplexType(8, "GridEnergy", [E3Int16(2, "ImpCumL", scale=1.0, signed=False), E3Int16(2, "ImpCumT", scale=1.0, signed=False), E3Int16(2, "ExpCumL", scale=1.0, signed=False), E3Int16(2, "ExpCumT", scale=1.0, signed=False),]),
