...
dataIdentifiersE3100CB = {
    ...
    "1385.5": O3EComplexType(4, "GridReactivePower", [O3EInt16(2, "Total", scale=1.0, signed=True)]),
    "1385.6": O3EComplexType(2, "GridCurrent", [O3EInt16(2, "Absolute L1", scale=1.0, signed=True)]),
    ...
    "1385.10": O3EComplexType(2, "GridCurrent", [O3EInt16(2, "Absolute L2", scale=1.0, signed=True)]),
    ...
    "1385.14": O3EComplexType(2, "GridCurrent", [O3EInt16(2, "Absolute L3", scale=1.0, signed=True)]),
